...
function Post({ post, onDelete, onLiked }) {
   ...
   return (
      <Article className={styles.post}>
         ...
         <Image source={post.image} alternative={post.title} className={styles.postImage} />
         <Container className={styles.buttonContainer}>
            <Button className={styles.likeButton} onClick={handleLike}>
               {post.likes.includes(userId) ? (
                  <>
                     ...
                     <Text className={styles.likeText}>{post.likes.length}</Text>
                  </>
               ) : (
                  <>
            ...
            {post.author.id === userId && (
               <Button className={styles.removePostButton} onClick={() => onDelete(post.id)}>
                  Delete
               </Button>
            )}
         </Container>
