console.info('CASE constructor an instance with 2 elements')

var fruits = new Array('Apple', 'Banana') //['Apple', 'Banana'];

console.assert(fruits instanceof Array, 'fruist is instance of Array')
...
console.info('CASE constructor an instance with length 3')
...
console.assert(fruits[1] === undefined, 'fruit at index 2 is undefined') 



console.info('CASE constructor an instance with 1 element')
