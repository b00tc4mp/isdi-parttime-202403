...
console.info('CASE inverts order of 3 nums')
...
console.info('CASE inverts order of 4 nums')
...
console.info('CASE inverts order of 5 nums')
...
console.info('CASE inverts order of 6 nums')
