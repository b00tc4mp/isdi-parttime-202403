//node staff/debora-garcia/playground/arrays/native-reloaded/Array.prototype.slice.demo_r.js
...
Array.prototype.slice=function (start, end) {
    ...
    fromIndex = start === undefined ? 0 : (start < 0 ? this.length + start : start)
    toIndex = end === undefined ? this.length : (end < 0 ? this.length + end : end)
