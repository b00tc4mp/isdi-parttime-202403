...
describe('modifyMySurname', () => {
    ...
    it('fails on non-existing user', () => {
        ...
        return modifyMySurname(new ObjectId().toString(), 'SRZ')
    ...
    it('fails on invalid surname', () => {
        ...
        try {
            modifyMySurname(new ObjectId().toString(), 1234)
        } catch (error) {
            errorThrown = error
        } finally {
            expect(errorThrown).to.be.instanceOf(ContentError)
